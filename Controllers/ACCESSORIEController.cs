...
namespace S_TCHAD.Controllers
{
    ...
    {
        private readonly IACCESSORIESERVICE _service;
        public ACCESSORIEController(IACCESSORIESERVICE service)
        {
            _service = service;
        }
        ...
        [HttpPost]
        public async Task<IActionResult> Edit(int id, [Bind("Name, PhotoURL1,PhotoURL2,PhotoURL3,Description,Sex")] ACCESSORIE abaya)
        {
            if (!ModelState.IsValid)
            {
                return View(abaya);
