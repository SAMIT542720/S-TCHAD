...
namespace S_TCHAD.Controllers
{
    public class HomeAccessoriesController : Controller
    {
        ...
        public HomeAccessoriesController(IHomeAccessoriesService service)
        {
            _service = service;
        }
        ...
        [HttpPost]
        public async Task<IActionResult> Create([Bind("Name, PhotoURL1,PhotoURL2,PhotoURL3,Description,Sex")] HomeAccessories abaya)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> Edit(int id, [Bind("Name, PhotoURL1,PhotoURL2,PhotoURL3,Description,Sex")] HomeAccessories abaya)
        {
            if (!ModelState.IsValid)
            {
                return View(abaya);
