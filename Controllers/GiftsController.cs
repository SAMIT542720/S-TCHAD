...
namespace S_TCHAD.Controllers
{
    public class GiftsController : Controller
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Create([Bind("Name, PhotoURL1,PhotoURL2,PhotoURL3,Description,Sex")] Gifts abaya)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> Edit(int id, [Bind("Name, PhotoURL1,PhotoURL2,PhotoURL3,Description,Sex")] Gifts abaya)
        {
            if (!ModelState.IsValid)
            {
                return View(abaya);
